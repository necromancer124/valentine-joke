...
public class seynara extends AppCompatActivity {

    private String[] s = {"Привет! сайнара Надеюсь у тебя счастливый День святого Валентина.",
            "Я действительно счастлив, что мы стали друзьями.",
            " Ты дружелюбный и весёлый человек.",
            " с тобой очень приятно и весело общятся", " поэтому я рад,что мы стали друзьями.",
            "И спасибо тебе", "блогодоря тебе я смог стать ведмочкой",
            " Кхм...", "было вкусно (облизался)",
            " Надеюсь, что мы сможем продолжить это дружбу на долгое время!",
            " С Днём святого Валентина! увидемся."};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seynara);

        T = findViewById(R.id.T);  // Corrected line
        b = findViewById(R.id.button);
        talk = findViewById(R.id.talk);
        imagearry=new int[]{R.drawable.sayonara1,R.drawable.sayonara2};
        ...
        skeletim=findViewById(R.id.imagesaynara);
