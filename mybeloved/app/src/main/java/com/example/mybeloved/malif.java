...
public class malif extends AppCompatActivity {
    Context c = this;
    private String[] s = {"Привет! лиз Надеюсь у тебя счастливый День святого Валентина.",
            "я щястлив что встретил тебя котик >:}", "лад сори за рак мозга.",
            " Ты такой милый, дружелюбный и весёлый человек.",
            " с тобой очень приятно и весело общятся", " поэтому я рад,что мы стали друзьями.",
            "Мне кажется, что твои стремления к идеалу – это очень круто.", "Я думаю, что если ты будешь правильно его использовать,", " то ты достигнешь великих вещей.", "спасибо за все!","увидемся."};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_malif);
        d = MediaPlayer.create(c, R.raw.lavendermist);
        T = findViewById(R.id.T);  // Corrected line
        b = findViewById(R.id.button);
        talk = findViewById(R.id.talk);
        necrotalk = findViewById(R.id.imageView);
        d.start();
        imagearry=new int[]{R.drawable.malif1,R.drawable.malif2};
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                d.stop();
                d = MediaPlayer.create(c, R.raw.poempanic);
                d.start();
        ...
        skeletim=findViewById(R.id.imagemalif);
        skeletim.setScaleX(-1);
